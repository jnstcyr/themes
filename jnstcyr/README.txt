...
The jnstcyr theme is provided for demonstration purposes; it uses Drupal's default
...
jnstcyr theme itself has no styling, except just enough CSS to arrange the page in
